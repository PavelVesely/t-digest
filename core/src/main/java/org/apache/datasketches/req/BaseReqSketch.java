...
abstract class BaseReqSketch {
   ...
   */
  public abstract double getRank(final double value);
   ...
   * @see #getRank(double)
   */
  public abstract double[] getRanks(final double[] values);
   ...
   * This can be set anytime prior to a {@link #getRank(double)} or {@link #getQuantile(double)} or
   * equivalent query.
   * @return this
   */
